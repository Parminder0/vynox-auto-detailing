    ...
    <div className="min-h-screen bg-[#f6f7fb] text-slate-800 font-inter">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-start mb-10 mt-2">
            ...
            <div className="text-center mt-3">
              <div className="font-semibold text-lg">{user?.name || "Guest User"}</div>
              <button
            ...
            {menuItems.map((item) => (
              <button
                ...
                className={`flex items-center gap-3 text-left w-full px-4 py-3 rounded-xl transition font-medium text-sm
                  ${
                    tab === item.id
                      ? "bg-[#07172F] font-bold text-[#FFCC66] shadow-inner"
      ...
      try {
       localStorage.removeItem("user");
         await signOut(auth); 
           localStorage.removeItem("user");
        router.push("/auth"); // ✅ Redirects to login page
        ...
        <main className="flex-1 w-full overflow-y-auto">
          <div className="max-w-7xl mx-auto p-4 sm:p-6 md:p-10">
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              {/* Greeting */}
              <h1
                className={`text-2xl md:text-3xl font-extrabold text-[#0B1E3F] ${
                  sidebarOpen ? "hidden" : ""
                } md:block`}
              >
                Hi, {user?.name || "User"} 👋
              ...
              <div className="flex items-center gap-4 ml-auto">
                ...
                <button
                  ...
                  className="p-2 rounded-full text-slate-600 hover:bg-slate-200 transition relative"
                >
